...
<head>
  ...
  <link rel="canonical" href="2d-logo-animation-packages" />
  <meta content="" name="author">
  <link rel="icon" type="image/png" href="../favicon.ico">
  <title>2D Logo Animation Packages</title>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="pkg_detail_sec">
            <h4>Logo Animation Packages</h4>
            <span class="line_through">$178.00</span>
            <span class="h5"><sup>$</sup> 149.00</span>
            <div class="btn_pkg">
              <a data-toggle="modal" data-target="#order_pop" onclick="order_now_value(this,60)" name="for $149.00" class="pkg-order-btn" tabindex="0">Get Started</a>
            </div>
          </div>
        </div>
        <div class="col-sm-8">
          <div class="pkg_list_detail">
            ...
            <ul class="pkg-list">
              <li><strong>2</strong> Concepts - HD 1080</li>
