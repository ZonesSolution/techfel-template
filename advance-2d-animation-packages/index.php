...
<head>
  ...
  <link rel="canonical" href="advance-2d-animation-packages" />
  <meta content="" name="author">
  <link rel="icon" type="image/png" href="../favicon.ico">
  <title>Advance 2D Animation Package</title>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="pkg_detail_sec">
            <h4>Advance 2D Animation <br> Packages</h4>
            <span class="line_through">$998.00</span>
            <span class="h5"><sup>$</sup> 499.00</span>
            <div class="btn_pkg">
              <a data-toggle="modal" data-target="#order_pop" onclick="order_now_value(this,62)" name="for $499.00" class="pkg-order-btn" tabindex="0">Get Started</a>
            </div>
          </div>
        </div>
        <div class="col-sm-8">
