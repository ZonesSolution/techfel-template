...
<head>
  ...
  <link rel="canonical" href="basic-2d-illustration-packages" />
  <meta content="" name="author">
  <link rel="icon" type="image/png" href="../favicon.ico">
  <title>Basic 2D Illustration Package</title>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="pkg_detail_sec">
            <h4>Basic 2D Illustration Package</h4>
            <span class="line_through">$798.00</span>
            <span class="h5"><sup>$</sup> 399.00</span>
            <div class="btn_pkg">
              <a data-toggle="modal" data-target="#order_pop" onclick="order_now_value(this,79)" name="for $399.00" class="pkg-order-btn" tabindex="0">Get Started</a>
            </div>
          </div>
        </div>
        <div class="col-sm-8">
