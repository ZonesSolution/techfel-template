...
<head>
  ...
  <link rel="canonical" href="basic-whiteboard-animation-packages/>
  <meta content="" name=" author">
  <link rel="icon" type="image/png" href="../favicon.ico">
  <title>Basic Whiteboard Animation Packages</title>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="pkg_detail_sec">
            <h4>Basic Whiteboard <br> Animation Packages</h4>
            <span class="line_through">$490.00</span>
            <span class="h5"><sup>$</sup> 245.00</span>
            <div class="btn_pkg">
              <a data-toggle="modal" data-target="#order_pop" onclick="order_now_value(this,70)" name="for $245.00" class="pkg-order-btn" tabindex="0">Get Started</a>
            </div>
          </div>
        </div>
        <div class="col-sm-8">
          <div class="pkg_list_detail">
            ...
            <ul class="pkg-list">
              <li><strong>15s Duration</strong> - HD 1080</li>
