...
<head>
  ...
  <link rel="canonical" href="classic-social-packages/>
  <meta content="" name=" author">
  <link rel="icon" type="image/png" href="../favicon.ico">
  <title>Classic Social Package</title>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="pkg_detail_sec">
            <h4>Classic Social Packages</h4>
            <span class="line_through">$298.00</span>
            <span class="h5"><sup>$</sup> 149.00</span>
            <div class="btn_pkg">
              <a data-toggle="modal" data-target="#order_pop" onclick="order_now_value(this,48)" name="for $149.00" class="pkg-order-btn" tabindex="0">Get Started</a>
            </div>
          </div>
        </div>
        <div class="col-sm-8">
