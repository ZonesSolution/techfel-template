...
<head>
  ...
  <link rel="canonical" href="motion-graphics-startup-packages/>
  <meta content="" name=" author">
  <link rel="icon" type="image/png" href="favicon.ico">
  <title>Motion Graphics Startup Packages</title>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="pkg_detail_sec">
            <h4>Motion Graphics <br> Startup Packages</h4>
            <span class="line_through">$390.00</span>
            <span class="h5"><sup>$</sup> 195.00</span>
            <div class="btn_pkg">
              <a data-toggle="modal" data-target="#order_pop" onclick="order_now_value(this,74)" name="for $195.00" class="pkg-order-btn" tabindex="0">Get Started</a>
            </div>
          </div>
        </div>
        <div class="col-sm-8">
