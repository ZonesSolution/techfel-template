...
<head>
  ...
  <link rel="canonical" href="premium-2d-illustration-packages/>
  <meta content="" name=" author">
  <link rel="icon" type="image/png" href="favicon.ico">
  <title>Premium 2D Illustration Package</title>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="pkg_detail_sec">
            <h4>Premium 2D Illustration Package</h4>
            <span class="line_through">$3990.00</span>
            <span class="h5"><sup>$</sup> 1995.00</span>
            <div class="btn_pkg">
              <a data-toggle="modal" data-target="#order_pop" onclick="order_now_value(this,82)" name="for $1995.00" class="pkg-order-btn" tabindex="0">Get Started</a>
            </div>
          </div>
        </div>
        <div class="col-sm-8">
