...
<head>
  ...
  <link rel="canonical" href="professional-bigcommerce-packages/>
  <meta content="" name=" author">
  <link rel="icon" type="image/png" href="favicon.ico">
  <title>Professional Bigcommerce Package</title>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="pkg_detail_sec">
            <h4>Professional Bigcommerce Packages</h4>
            <span class="line_through">$2698.00</span>
            <span class="h5"><sup>$</sup> 1349.00</span>
            <div class="btn_pkg">
              <a data-toggle="modal" data-target="#order_pop" onclick="order_now_value(this,28)" name="for $1349.00" class="pkg-order-btn" tabindex="0">Get Started</a>
            </div>
          </div>
        </div>
        <div class="col-sm-8">
