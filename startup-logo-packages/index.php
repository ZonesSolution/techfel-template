...
<head>
  ...
  <link rel="canonical" href="startup-logo-packages/>
  <meta content="" name=" author">
  <link rel="icon" type="image/png" href="favicon.ico">
  <title>Start Up Logo Packages</title>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="pkg_detail_sec">
            ...
            <span class="line_through">$ 168.00</span>
            <span class="h5"><sup>$ </sup> 74.00</span>
            <div class="btn_pkg">
              <a data-toggle="modal" data-target="#order_pop" onclick="order_now_value(this,2)" name="for $74" class="pkg-order-btn" tabindex="0">Get Started</a>
            </div>
          </div>
        </div>
        <div class="col-sm-8">
