...
<head>
  ...
  <link rel="canonical" href="unlimited-social-packages/>
  <meta content="" name=" author">
  <link rel="icon" type="image/png" href="favicon.ico">
  <title>Unlimited Social Package</title>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="pkg_detail_sec">
            <h4>Unlimited Social Package</h4>
            <span class="line_through">$1998.00</span>
            <span class="h5"><sup>$</sup> 999.00</span>
            <div class="btn_pkg">
              <a data-toggle="modal" data-target="#order_pop" onclick="order_now_value(this,50)" name="for $999.00" class="pkg-order-btn" tabindex="0">Get Started</a>
            </div>
          </div>
        </div>
        <div class="col-sm-8">
